...
class TestApprovalStampIsTheServers(unittest.TestCase):
	...
	def test_the_approval_path_may_stamp(self):
		...
		doc = self._doc(previous=previous, status="Approved", approved_by="dir@example.com",
	...
	def test_an_unchanged_stamp_passes_on_a_later_edit(self):
		...
		doc = self._doc(previous=previous, approved_by="dir@example.com",
		                approved_at="2026-08-02 10:00:00", selection_reason="Reworded.")
		doc.validate()
