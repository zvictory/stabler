	...
	def __init__(self):
		self.docs = {
			...
			("Tender Sourcing Decision", "TSD-DRAFT"): _Doc(
				name="TSD-DRAFT", company="ACME", deal="LOT-C", status="Draft",
				selected_quotation="SQ-DRAFT", selection_reason="Fits the deadline.",
			),
			("Tender Sourcing Decision", "TSD-APPROVED"): _Doc(
				name="TSD-APPROVED", company="ACME", deal="LOT-B", status="Approved",
				selected_quotation="SQ-OTHER-LOT", approved_by="dir@example.com",
			),
			("Tender Sourcing Decision", "TSD-OTHER-COMPANY"): _Doc(
				name="TSD-OTHER-COMPANY", company="Other Co", deal="LOT-OTHER", status="Draft",
			),
		...
		self.quotation_rows = [
			{"name": "SQ-DRAFT", "supplier": "SUP-A", "supplier_name": "Alfa", "country": "Uzbekistan",
			 "currency": "USD", "grand_total": 100.0, "base_total": 1200.0, "cheapest": True},
			{"name": "SQ-SUBMITTED", "supplier": "SUP-B", "supplier_name": "Beta", "country": "China",
			 "currency": "USD", "grand_total": 130.0, "base_total": 1560.0, "cheapest": False},
		]
	...
	def test_a_lot_gets_one_open_award_at_a_time(self):
		...
		with self.assertRaises(ValueError):
			api.save_sourcing_decision(
				deal="LOT-C", selected_quotation="SQ-SUBMITTED", selection_reason="Second opinion.",
