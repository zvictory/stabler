...
class BlockersTest(unittest.TestCase):
    ...
    def test_no_declarations_is_a_blocker_not_a_pass(self):
        self.assertEqual(codes(dm.departure_blockers([], vet_valid=True)),
    ...
    def test_missing_vet_certificate(self):
        self.assertEqual(codes(dm.departure_blockers([D()], vet_valid=False)),
                         ["vet_certificate_missing"])
...
class MayDepartTest(unittest.TestCase):
    ...
    def test_override_with_reason_allows_and_still_reports(self):
        ...
        self.assertEqual(codes(r["blockers"]),
                         ["no_required_declaration", "vet_certificate_missing"])
...
class TransitionScopeTest(unittest.TestCase):
    ...
    def test_later_steps_are_not_gated(self):
        for a, b in [("DEPARTED_IRAN", "AT_BORDER"), ("AT_BORDER", "CROSSED_BORDER"),
                     ("ARRIVED", "UNLOADING"), ("UNLOADING", "GRN_CREATED")]:
