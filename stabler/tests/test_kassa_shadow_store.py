...
class TestShadowStore(unittest.TestCase):
    ...
    def test_opening_and_empty_balance(self):
        ...
        self.assertEqual(ss.balances(self.path, CO, D),
                         {"nakit": 402_250_000.0, "pk": 3_000_000.0, "usd": 400.0})
    ...
    def test_multi_leg_kirim_updates_balances(self):
        ...
        ss.add_entry(self.path, company=CO, kassir="7001", op="kirim",
                     ...
                     deltas=[{"kassa": "nakit", "delta": 2_000_000},
                             ...
                             {"kassa": "usd", "delta": 500}])
        self.assertEqual(ss.balances(self.path, CO, D),
                         {"nakit": 404_250_000.0, "pk": 6_000_000.0, "usd": 900.0})
    ...
    def test_list_and_delete(self):
        eid = ss.add_entry(self.path, company=CO, kassir="7001", op="kirim",
                           counterparty="Ali", raw_text="Alidan 600 ming oldim",
                           parsed={"op": "kirim"},
    ...
    def test_company_isolation(self):
        ss.add_entry(self.path, company="mikas", kassir="1", op="kirim",
                     deltas=[{"kassa": "nakit", "delta": 500}], date=D)
        ss.add_entry(self.path, company="other", kassir="2", op="kirim",
                     deltas=[{"kassa": "nakit", "delta": 999}], date=D)
