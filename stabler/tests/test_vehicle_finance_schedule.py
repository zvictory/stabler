...
def setUpModule():
	...
	vehicle_agreement = importlib.import_module("stabler.stabler.doctype.vehicle_agreement.vehicle_agreement")
...
class TestBalloon(unittest.TestCase):
	def test_balloon_becomes_the_final_row_and_absorbs_residual(self):
		...
		# financed = 700 over 3 installments = 233.33 x3 = 699.99
...
class TestAgreementMoneyInvariants(unittest.TestCase):
	...
	def test_party_type_derives_from_direction(self):
		self.assertEqual(vehicle_agreement.PARTY_TYPE_BY_DIRECTION["Acquisition"], "Supplier")
		self.assertEqual(vehicle_agreement.PARTY_TYPE_BY_DIRECTION["Disposition"], "Customer")
