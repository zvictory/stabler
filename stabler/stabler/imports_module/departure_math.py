...
def is_cleared(declaration) -> bool:
	...
	"""
	return bool(
		declaration and str(declaration.get("status") or "") == "Approved" and declaration.get("cleared_date")
	)
...
def may_depart(declarations, *, vet_valid: bool, override: bool = False, override_reason: str = "") -> dict:
