	...
	create_custom_fields(
		{
			"CRM Deal": [
				...
				{
					"fieldname": "next_action_owner",
					"label": "Next Action Owner",
					"fieldtype": "Link",
					"options": "User",
					"insert_after": "next_action_at",
				},
				{
					"fieldname": "stage_entered_at",
					"label": "Stage Entered At",
					"fieldtype": "Datetime",
					"read_only": 1,
					"insert_after": "next_action_owner",
				},
				{
					"fieldname": "won_at",
					"label": "Won At",
