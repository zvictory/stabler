...
_FIELDS = [
    {"fieldname": "stabler_remittance_id", "label": "Remittance ID", "fieldtype": "Data",
     "insert_after": "cheque_date", "read_only": 1, "no_copy": 1},
    {"fieldname": "stabler_remittance_stage", "label": "Remittance Stage", "fieldtype": "Select",
     "options": "\nRegister\nPayout\nRefund", "insert_after": "stabler_remittance_id",
     "read_only": 1, "no_copy": 1},
    {"fieldname": "stabler_pickup_code", "label": "Pickup Code", "fieldtype": "Data",
     "insert_after": "stabler_remittance_stage", "read_only": 1, "no_copy": 1, "hidden": 1},
    {"fieldname": "stabler_sender_name", "label": "Sender", "fieldtype": "Data",
     "insert_after": "stabler_pickup_code", "read_only": 1, "no_copy": 1},
    {"fieldname": "stabler_receiver_name", "label": "Receiver", "fieldtype": "Data",
     "insert_after": "stabler_sender_name", "read_only": 1, "no_copy": 1},
]
