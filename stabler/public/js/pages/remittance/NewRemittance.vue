 ...
 *
 * Registers through `remittance_commands.register_remittance`. This screen was
 * once one of two variants behind a switcher, because the JE-only engine had its
 * own New Transfer form; that engine was retired on 2026-08-20 with no tenant on
 * it, and the switcher and the legacy form went with it.
 *
