...
const tabs = [
	...
	{ name: "sales-quotations", path: "/sales/quotations", label: t("Quotations"), icon: "ti-file-description" },
...
<template>
	<ModuleHeader :title='t("Sales")' icon="ti-trending-up" :tabs="tabs" :active-tab="activeTab" />
