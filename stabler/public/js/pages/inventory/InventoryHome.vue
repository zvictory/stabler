...
const tabs = [
	...
	{ name: "inventory-item-groups", path: "/inventory/categories", label: t("Categories"), icon: "ti-category-2" },
...
<template>
	<ModuleHeader :title='t("Inventory")' icon="ti-package" :tabs="tabs" :active-tab="activeTab" />
