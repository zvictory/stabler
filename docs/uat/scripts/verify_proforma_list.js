...
async function verifyList() {
	...
	await page.goto('https://msa.erpstable.com/stabler#/imports/proformas', { waitUntil: 'domcontentloaded' });
	await page.waitForTimeout(4000);

	await page.screenshot({ path: path.join(ARTIFACTS_DIR, '21_msa_proforma_list_updated.png'), fullPage: false, timeout: 5000 });
	console.log('Screenshot 21_msa_proforma_list_updated.png saved.');

	await browser.close();
}

verifyList().catch(console.error);
